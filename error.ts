...
/**
 * This class provides a wrapper for network errors when making requests to person
 */
export class WorkdayPersonError extends Error {
  /**
   * The response body
   */
